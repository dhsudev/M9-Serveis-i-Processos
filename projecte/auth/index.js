...
app.get('/protected', (req, res) => {
	const { user } = req.session;
	if (!user) {
		// Redirigir a la pàgina principal amb un missatge d'error
		return res.status(403).redirect('/?error=acceso_no_autorizado');
	}
	// Mostrar informació personalitzada a la pàgina protegida
